...
The adapter's deletion target is the first pi-gentic release that requires Pi 0.83.0 or later, provided the public host contract passes the same compatibility suite. Until that gate passes, package peers remain pinned to Pi 0.82.1.
