...
Version `0.4.0` requires Pi `0.84.0` exactly. The adapter checks both that version and the private capabilities it needs before installation. An unsupported host fails early with a compatibility message.
