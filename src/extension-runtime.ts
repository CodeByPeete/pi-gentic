...
import { DelegationFibersLive } from "./delegation/runs.js";
import { GitClient } from "./worktrees/git.js";
import { WorktreeManager, type PrepareWorktreeRequest } from "./worktrees/manager.js";
import { WorktreeManagerLive } from "./worktrees/manager.js";
...
const ExtensionLayer = Layer.mergeAll(NodeServices.layer, WorktreeLayer, DelegationFibersLive);
...
export function createExtensionRuntime() {
  const runtime = ManagedRuntime.make(ExtensionLayer);
