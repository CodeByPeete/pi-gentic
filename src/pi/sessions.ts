...
import { getLiveRuntimeState, loadPiCodingAgentPeer } from "./runtime.js";
...
export const activeVisibleExtension = () => getLiveRuntimeState().activeApi;
export const activeVisibleContext = () => getLiveRuntimeState().activeContext;
export const activeVisibleSession = () => getLiveRuntimeState().activeSession;
