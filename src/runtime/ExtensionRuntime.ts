...
export function shouldDisposeExtensionRuntime(
...
export const prepareWorktreeEffect = Effect.fn(
  "ExtensionRuntime.prepareWorktree",
)(function* (request: PrepareWorktreeRequest) {
